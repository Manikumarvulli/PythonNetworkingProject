...
class DB_Access:
    ...
    def __init__(self):
        ...
        self.db = mysql.connector.connect(host='127.0.0.1', user="root", password="Man@8639", database="network")
    ...
    def error(self):
        ...
        Label(err, text="All fields are required..", fg="blue", font="bold").pack()
        Label(err, text="").pack()
        Button(err, text="Ok", bg="grey", width=10, height=2, command=self.error_destroy).pack()

    # success message pop-up box design
    def success(self):
        global succ
        succ = Toplevel(root1)
        succ.title("Registration Successful")
    ...
    def register_user(self):
        ...
        if username_info == "":
            ...
            sql = "insert into details_table values(%s,%s,%s,%s)"
    ...
    def registration(self):
        ...
        Label(root1, text="").pack()
        Button(root1, text="Register", bg="blue", command=self.register_user).pack()
    ...
    def login(self):
        ...
        Label(root2, text="").pack()
        Button(root2, text="Log-In", bg="blue", command=self.login_varify).pack()
        Label(root2, text="")
    ...
    def login_varify(self):
            ...
            sql = "select * from details_table where username = %s and password = %s"
